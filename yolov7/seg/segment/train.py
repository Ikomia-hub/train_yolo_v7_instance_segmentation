...
import train_yolo_v7_instance_segmentation.yolov7.seg.segment.val as validate  # for end-of-epoch mAP
from train_yolo_v7_instance_segmentation.yolov7.seg.models.experimental import attempt_load
from train_yolo_v7_instance_segmentation.yolov7.seg.models.yolo import SegmentationModel
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.autoanchor import check_anchors
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.autobatch import check_train_batch_size
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.callbacks import Callbacks
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.downloads import attempt_download, is_url
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.general import (LOGGER, check_amp, check_dataset, check_file, check_git_status, check_img_size,
...
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.loggers import GenericLogger
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.plots import plot_evolve, plot_labels
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.segment.dataloaders import create_dataloader
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.segment.loss import ComputeLoss
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.segment.metrics import KEYS, fitness
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.segment.plots import plot_images_and_masks, plot_results_with_masks
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.torch_utils import (EarlyStopping, ModelEMA, de_parallel, select_device, smart_DDP, smart_optimizer,
        ...
        for i, (imgs, targets, paths, _, masks) in pbar:  # batch ------------------------------------------------------
            ...
            if ni <= nw:
                ...
                for j, x in enumerate(optimizer.param_groups):
                    ...
                    x['lr'] = interp(ni, xi, [hyp['warmup_bias_lr'] if j == 0 else 0.0, x['initial_lr'] * lf(epoch)])
                    if 'momentum' in x:
