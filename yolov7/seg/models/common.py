...
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.dataloaders import exif_transpose, letterbox
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
...
from train_yolo_v7_instance_segmentation.yolov7.seg.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from train_yolo_v7_instance_segmentation.yolov7.seg.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
